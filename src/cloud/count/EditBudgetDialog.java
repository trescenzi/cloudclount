...
public final class EditBudgetDialog extends javax.swing.JDialog {
    ...
    {
        EditBudgetTableModel model = (EditBudgetTableModel) incomeTable.getModel();
        model.setSide(BridgeConstants.Side.INCOME);
        ...
        EditBudgetTableRender myTableRenderer = new EditBudgetTableRender();
            ...
            {        
                ...
                if (e.getClickCount() == 2) 
                {
                    ...
                    SwingUtilities.invokeLater(new Runnable() 
                    {
                        ...
                        public void run() 
                        {
                            editEntry(row, BridgeConstants.Side.INCOME);
                        }
                    });
                }
            }
            ...
            {        
                ...
                if (e.getClickCount() == 2) 
                {
                    ...
                    SwingUtilities.invokeLater(new Runnable() 
                    {
                        ...
                        public void run() 
                        {
                            editEntry(row, BridgeConstants.Side.EXPENDITURE);
                        }
                    });
                }
            }
    ...
    */
    public void editEntry(int row, Side side)
    {
        Line line = (Line) budget.fetchLines(side).get(row);
        UpdateLineDialog dialog = new UpdateLineDialog(null, true, line);
        // Center Dialog
    ...
    protected void initEditBudgetAttachmentsTable()
    {
        ...
        attachmentsTable.addMouseListener(new MouseAdapter() 
        {
            ...
            {        
                ...
                // Right Click
                // I found this code from Stack oeeeverflow
    ...
    private void initComponents() {
        ...
        incomeTable.setModel(new cloud.count.EditBudgetTableModel());
        ...
        expendituresTable.setModel(new cloud.count.EditBudgetTableModel());
        ...
        notesPanelLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, notesPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(notesScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 518, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        auditTrailPanelLayout.setVerticalGroup(
            auditTrailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(auditTrailPanelLayout.createSequentialGroup()
                .add(auditTrailPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 562, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void refreshButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshButtonActionPerformed
       EBAttachmentsTableModel attach = (EBAttachmentsTableModel) attachmentsTable.getModel();
       attach.refresh();
       EditBudgetTableModel income = (EditBudgetTableModel) incomeTable.getModel();
       income.refresh();
...
//                dialog.setLocationRelativeTo(null);
    ...
    private void addNoteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNoteButtonActionPerformed
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                Note newNote = (Note) budget.createNote();
