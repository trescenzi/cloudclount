...
public class UpdateLineDialog extends javax.swing.JDialog {
     ...
     */
    public UpdateLineDialog(java.awt.Frame parent, boolean modal, Line line) {
        super(parent, modal);
        this.line = line;
        initComponents();
        //init();
...
//    }
    ...
    private void initComponents() {
        ...
        lineNumTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lineNumTextFieldActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                UpdateLineDialog dialog = new UpdateLineDialog(new javax.swing.JFrame(), true, line);
